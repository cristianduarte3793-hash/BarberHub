...
def barbero_dashboard(request):
    """Dashboard del barbero con métricas del día y próximas citas."""
    ...
    return render(request, 'agenda/barbero/dashboard.html', {
        'barbero': barbero,
        'citas_hoy': citas_hoy,
...
def barbero_agenda(request):
    """Vista de agenda del barbero con vistas: día, semana, mes."""
    barbero = request.user.perfil.barbero
    hoy = timezone.localdate()
    ...
    return render(request, 'agenda/barbero/agenda.html', {
        'barbero': barbero,
        'citas': citas,
        'vista': vista,
        'offset': offset,
...
def barbero_cita_detalle(request, pk):
    """Detalle completo de una cita del barbero."""
    barbero = request.user.perfil.barbero
    ...
    return render(request, 'agenda/barbero/detalle_cita.html', {
        'cita': cita,
...
def barbero_historial(request):
    """Historial de citas finalizadas y canceladas del barbero."""
    barbero = request.user.perfil.barbero
    ...
    return render(request, 'agenda/barbero/historial.html', {
        'barbero': barbero,
        'citas': citas,
...
# ===========================================================================
# DISPONIBILIDAD (vista dedicada)
# ===========================================================================

@login_required
@barbero_required
def barbero_disponibilidad(request):
    """Vista dedicada para gestionar disponibilidad del barbero."""
    barbero = request.user.perfil.barbero
    return render(request, 'agenda/barbero/disponibilidad.html', {
        'barbero': barbero,
    })
...
def barbero_perfil(request):
    ...
    return render(request, 'agenda/barbero/perfil.html', {
        'form': form,
        'perfil': perfil,
        'barbero': barbero,
        'calificacion_promedio': calificacion_promedio,
